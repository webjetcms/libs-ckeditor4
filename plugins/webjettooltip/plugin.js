...
CKEDITOR.plugins.add('webjettooltip', {
  ...
  init: function(editor) {
    ...
    editor.ui.addButton('Tooltip', {
      label: editor.lang.webjettooltip.button,
      command: 'tooltip',
      toolbar: 'insert',
      icon: this.path + 'icons/tooltip.png'
    });
    editor.ui.addButton('RemoveTooltip', {
      label: editor.lang.webjettooltip.remove,
