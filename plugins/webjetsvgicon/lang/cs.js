CKEDITOR.plugins.setLang('webjetsvgicon', 'cs', {
    title: 'Vlastnosti SVG ikony',
    buttonLabel: 'Vložit SVG ikonu',
    icons: 'Ikony',
    advanced: 'Pokročilé',
    ...
    withTextEnd: 'Přidat rozestup pro text',
    customClass: 'Vlastní CSS třídy',
    defaultSize: 'Výchozí velikost',
